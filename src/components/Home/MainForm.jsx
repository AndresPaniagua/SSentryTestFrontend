...
export default function MainForm() {
  ...
  const validForm = () => {
    ...
    if (isEmpty(NIT)) {
      setErrorMessage(
        "Debes ingresar el número de identificación de la empresa"
      );
      setError(true);
      isValid = false;
    }
    ...
    <Fragment>
      <div className="body-External">
        <div className="body-Internal">
          <br />
          <h1 style={{textAlign: 'center'}}>Inscripción al servicio</h1>
          <hr />
          <p style={{textAlign: 'center'}}>
            Ingrese el NIT de la persona natural o jurídica para la que
            realizará el trámite, sin incluir el dígito de verificación. Luego
            selecione <strong>Continuar </strong>
          ...
          <Form onSubmit={validCompanyID}>
            <Row className="mb-3">
              <Form.Group as={Col} controlId="companyId" style={{borderBottom: '2px solid #adadad'}}>
